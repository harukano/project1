				...
				<tbody class="formtype">
					<tr>
						...
						<td class="subject" colspan="3">
							<input id="film_name" name="film_name" type="text" class="txttype" style="width:570px;" />
						</td>
					</tr>
					<tr>
							...
							<select name="genre_code" id="genre_code" style="width:140px;">
										...
										<c:if test="${!empty genre }">
											<c:forEach var="list" items="${genre }">
												<option value="${list.genre_code }">${list.genre_description }</option>
											</c:forEach>
										</c:if>
							</select>
					...
					<tr>
						...
						<td colspan="3">
							<input id="film_release_date" name="film_release_date" type="text" class="txttype" style="width:65px;" readonly="readonly"/>
							~
							<input id="film_close_date" name="film_close_date" type="text" class="txttype" style="width:65px;" readonly="readonly"/>
						</td>
					...
					<tr> 
						...
						<td>
							<input id=film_director name="film_director" type="text" class="txttype" style="width:150px;"/>
						</td>
					...
					<tr>
						...
						<td>
							<input id=film_cast name="film_cast" type="text" class="txttype" style="width:450px;"/>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<textarea id="film_synopsys" name="film_synopsys" rows="10" cols="94"></textarea>	
						</td>
					</tr>
